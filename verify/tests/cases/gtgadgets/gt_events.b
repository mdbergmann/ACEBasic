' gt_events.b - Phase 5 test: GadTools event handling
' Creates a button, verifies event system is initialized.
' Uses non-blocking GADGET(0) to check event state.
'
' Expected log (RAM:gt_events.log):
'   PASS: button created
'   PASS: no event pending
'   DONE

WINDOW 1,"GadTools Event Test",(0,0)-(320,200),30

OPEN "O",#1,"RAM:gt_events.log"

GADGET 1, 1, "Click Me", (100,80)-(220,100), BUTTON_KIND
