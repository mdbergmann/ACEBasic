...
IF <arg2> GT ""
 ...
 IF NOT ERROR
   ...
   IF NOT ERROR
     ...
     vasmm68k_mot -Fhunk -o ram:t/<arg2>.o ram:t/<arg2>.s
     delete >NIL: ram:t/<arg2>.s
     vlink -bamigahunk -x -Bstatic -Cgnu -nostdlib -mrel -s -o ram:t/<arg2> ram:t/<arg2>.o <arg3> ACElib:startup.lib ACElib:db.lib ACElib:ami.lib
...
ELSE
 ...
 IF NOT ERROR
   ...
   IF NOT ERROR
     ; assemble and link.
     delete >NIL: ram:t/$source
     vasmm68k_mot -Fhunk -o ram:t/<arg1>.o ram:t/<arg1>.s
     delete >NIL: ram:t/<arg1>.s
     vlink -bamigahunk -x -Bstatic -Cgnu -nostdlib -mrel -s -o ram:t/<arg1> ram:t/<arg1>.o <arg2> ACElib:startup.lib ACElib:db.lib ACElib:ami.lib
