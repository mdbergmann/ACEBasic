...
char *rword[] = 
  { 
    ...
    "LTRIM$","MESSAGE","MSGBOX","MX_KIND","NUMBER_KIND","PALETTE_KIND",
    "PENDOWN","PENUP","POTX",
    "POTY","PRINTS","REPEAT","REPEAT$","REPLACE$","REVERSE$","RINSTR","RTRIM$","SCROLLER_KIND","SERIAL","SETATTR","SETHEADING","SETXY","SHL",
