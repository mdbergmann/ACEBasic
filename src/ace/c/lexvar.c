...
char *rword[] = 
  { 
    ...
    "FMT$","FONT","FORWARD","GADGET","GETATTR","GLOBAL","HANDLE","HEADING","HOME","IFF","INPUTBOX",
    "INPUTBOX$","INTEGER_KIND","INVOKABLE","INVOKE","LISTVIEW_KIND","LONGINT",
    "LPAD$","LTRIM$","MESSAGE","MSGBOX","MX_KIND","NUMBER_KIND","PALETTE_KIND",
    "PENDOWN","PENUP","POTX",
    "POTY","PRINTS","REPEAT","REPEAT$","REPLACE$","REVERSE$","RINSTR","RPAD$","RTRIM$","SCROLLER_KIND","SERIAL","SETATTR","SETHEADING","SETXY","SHL",
    "SHORTINT","SHR","SINGLE","SIZE","SIZEOF","SLIDER_KIND",
    "STARTSWITH","STRING","STRING_KIND","STRUCT","STYLE","TEXT_KIND","TRIM$","TURN",
